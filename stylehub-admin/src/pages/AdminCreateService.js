...
import { adminCreateService } from '../api/adminService';
...
function AdminCreateService() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccess('Service created successfully! You can create another or go back.');
  ...
  return (
    <Page title="Create New Service (Admin)">
      ...
      <div style={{
        ...
        <p style={{ color: 'rgba(255, 255, 255, 0.7)', marginBottom: '24px' }}>
          This service will be owned by the platform (no provider).
        </p>
