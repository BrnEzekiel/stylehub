...
var UsersService = function () {
    ...
    var UsersService = _classThis = /** @class */ (function () {
        ...
        UsersService_1.prototype.findByPhone = function (phone) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.user.findUnique({
                            where: { phone: phone },
        ...
        UsersService_1.prototype.create = function (data) {
            return __awaiter(this, void 0, void 0, function () {
                var _this = this;
                return __generator(this, function (_a) {
                    // This is the critical step from Spec 6.1
                    // We create the User and their Wallet in a single transaction
                    return [2 /*return*/, this.prisma.$transaction(function (tx) { return __awaiter(_this, void 0, void 0, function () {
                            var user;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, tx.user.create({ data: data })];
                                    case 1:
                                        user = _a.sent();
                                        ...
                                        return [4 /*yield*/, tx.wallet.create({
                                                data: {
                                                    user_id: user.id,
                                                    balance_cents: 0, // Start with 0 balance
                                                    currency: 'KES',
                                                },
                                            })];
                                    case 2:
